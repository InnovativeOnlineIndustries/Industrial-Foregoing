...
public class CrimedGeneratorType implements IMycelialGeneratorType{
    ...
    private Pair<Integer, Integer> calculate(ItemStack stack){
        if (stack.getItem() == Items.CRIMSON_FUNGUS || stack.getItem() == Items.CRIMSON_ROOTS || stack.getItem() == Items.WEEPING_VINES
                ||stack.getItem() == Items.WARPED_FUNGUS ||stack.getItem() == Items.WARPED_ROOTS ||stack.getItem() == Items.NETHER_SPROUTS ||stack.getItem() == Items.TWISTING_VINES) return Pair.of(10*20, 20);
        if (stack.getItem() == Items.SHROOMLIGHT)  return Pair.of(10*20, 40);
        if (stack.getItem() == Items.NETHER_WART_BLOCK || stack.getItem() == Items.WARPED_WART_BLOCK )  return Pair.of(20*20, 40);
        return Pair.of(0, 80);
    }
