...
public class IndustrialTagsProvider {
    ...
    public static class Blocks extends BlockTagsProvider {
        ...
        protected void registerTags() {
            getOrCreateBuilder(IndustrialTags.Blocks.MACHINE_FRAME_PITY).add(ModuleCore.PITY);
            getOrCreateBuilder(IndustrialTags.Blocks.MACHINE_FRAME_SIMPLE).add(ModuleCore.SIMPLE);
            getOrCreateBuilder(IndustrialTags.Blocks.MACHINE_FRAME_ADVANCED).add(ModuleCore.ADVANCED);
            getOrCreateBuilder(IndustrialTags.Blocks.MACHINE_FRAME_SUPREME).add(ModuleCore.SUPREME);
            getOrCreateBuilder(IndustrialTags.Blocks.SAPLING).add(net.minecraft.block.Blocks.ACACIA_SAPLING, net.minecraft.block.Blocks.SPRUCE_SAPLING, net.minecraft.block.Blocks.BIRCH_SAPLING,
    ...
    public static class Items extends ItemTagsProvider {
        ...
        protected void registerTags() {
            ...
            getOrCreateBuilder(IndustrialTags.Items.PLASTIC).add(ModuleCore.PLASTIC);
            getOrCreateBuilder(IndustrialTags.Items.SLUDGE_OUTPUT).add(net.minecraft.item.Items.DIRT, net.minecraft.item.Items.CLAY, net.minecraft.item.Items.GRAVEL, net.minecraft.item.Items.SAND, net.minecraft.item.Items.RED_SAND, net.minecraft.item.Items.SOUL_SAND);
