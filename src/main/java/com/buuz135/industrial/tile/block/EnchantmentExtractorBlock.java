...
public class EnchantmentExtractorBlock extends CustomOrientedBlock<EnchantmentExtractorTile> {
    ...
    public List<IPage> getBookDescriptionPages() {
        ...
        pages.add(0, new PageText("When provided with power, a " + PageText.bold("book") + " and a " + PageText.bold("enchanted") + " item it will remove " + PageText.bold("1") + " enchantment from the item and apply it to the book.\n\nThe enchanted item won't be damaged in the process."));
        return pages;
    }
}
